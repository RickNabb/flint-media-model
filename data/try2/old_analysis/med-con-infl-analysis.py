...
def loop_per_row(df_adj, google_trends_data):
    ...
    df_new.to_csv("med-con-infl-analysis.csv")
    sns.scatterplot(data=df_new, x='rmse', y='corr_coef')
    plt.title("Media Connection Influence Model Sweep Analysis")
    plt.xlabel("RMSE")
    ...
    plt.legend()
    plt.title("Min RMSE Media Conn Influence Model_Sweep_Analysis")
    plt.show()
    ...
    plt.legend()
    plt.title("Max CC Media Conn Influence Model_Sweep_Analysis")
    plt.show()
    ...
    plt.plot(time_list, google_trends_data, label= 'gooogle trends')
    plt.legend()
    plt.title("Max RMSE Media Conn Influence Model_Sweep_Analysis")
    plt.show()
...
main('media-connections-influence-model-sweep.csv')
